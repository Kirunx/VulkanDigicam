...
void TextureRenderSystem::createPipelineLayout(VkDescriptorSetLayout globalSetLayout) {
    ...
    renderSystemLayout = VpDescriptorSetLayout::Builder(vpDevice)
    ...
    if (vkCreatePipelineLayout(vpDevice.device(), &pipelineLayoutInfo, nullptr, &pipelineLayout) != VK_SUCCESS) {
...
void TextureRenderSystem::renderGameObjects(FrameInfo& frameInfo) {
    ...
    for (auto& kv : frameInfo.gameObjects) {
        ...
        VpDescriptorWriter(*renderSystemLayout, frameInfo.frameDescriptorPool)
